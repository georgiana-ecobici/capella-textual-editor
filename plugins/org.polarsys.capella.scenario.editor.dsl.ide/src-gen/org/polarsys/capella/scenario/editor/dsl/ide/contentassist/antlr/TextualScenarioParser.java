...
public class TextualScenarioParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TextualScenarioGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSequenceMessageAccess().getArrowAssignment_1(), "rule__SequenceMessage__ArrowAssignment_1");
			...
			builder.put(grammarAccess.getSequenceMessageAccess().getDoubleDotAssignment_5(), "rule__SequenceMessage__DoubleDotAssignment_5");
			...
			builder.put(grammarAccess.getCreateMessageAccess().getArrowAssignment_1(), "rule__CreateMessage__ArrowAssignment_1");
			builder.put(grammarAccess.getCreateMessageAccess().getTargetAssignment_2(), "rule__CreateMessage__TargetAssignment_2");
			builder.put(grammarAccess.getCreateMessageAccess().getDoubleDotAssignment_3(), "rule__CreateMessage__DoubleDotAssignment_3");
			...
			builder.put(grammarAccess.getDeleteMessageAccess().getArrowAssignment_1(), "rule__DeleteMessage__ArrowAssignment_1");
			builder.put(grammarAccess.getDeleteMessageAccess().getTargetAssignment_2(), "rule__DeleteMessage__TargetAssignment_2");
			builder.put(grammarAccess.getDeleteMessageAccess().getDoubleDotAssignment_3(), "rule__DeleteMessage__DoubleDotAssignment_3");
